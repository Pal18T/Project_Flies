...
public:
    void createSchedule()       //UTC-001 & AD-001
    {
        ...
        ofstream f1("C:\\Users\\Prince Pal\\Desktop\\Training-Schedule-Management\\Project_Flies\\data\\schedule.csv", ios::app);
    ...
    void updateSchedule()       //UTC-002 & AD-002
    {
        ...
        file.open("C:\\Users\\Prince Pal\\Desktop\\Training-Schedule-Management\\Project_Flies\\data\\schedule.csv", ios::in);
        int count = 0;
        vector<string> v;
        ...
        file.open("C:\\Users\\Prince Pal\\Desktop\\Training-Schedule-Management\\Project_Flies\\data\\schedule.csv", ios::out | ios::trunc);
    ...
    void allotTrainer()         //UTC-003 & AD-003
    {
        ...
        ifstream f2("C:\\Users\\Prince Pal\\Desktop\\Training-Schedule-Management\\Project_Flies\\data\\schedule.csv");
        while (f2 >> batchID >> technology >> startDate >> endDate >> nod >> venueDetail >> nop >> month)
        {
            ...
            ofstream f3("C:\\Users\\Prince Pal\\Desktop\\Training-Schedule-Management\\Project_Flies\\data\\schedule.csv", ios::app);
    ...
    void generateReport()           //UTC-004 & AD-004
    {
        ...
        ifstream f3("C:\\Users\\Prince Pal\\Desktop\\Training-Schedule-Management\\Project_Flies\\data\\schedule.csv");
